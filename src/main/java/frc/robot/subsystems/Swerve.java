...
public class Swerve extends SuperSystem {
    ...
    public Swerve() {
        ...
        mSwerveMods = new SwerveModule[] {
            new SwerveModule(0, Constants.SwerveConst.Mod0.constants),
            new SwerveModule(1, Constants.SwerveConst.Mod1.constants),
            new SwerveModule(2, Constants.SwerveConst.Mod2.constants),
            new SwerveModule(3, Constants.SwerveConst.Mod3.constants)
        };
        ...
        swerveOdometry = new SwerveDriveOdometry(Constants.SwerveConst.swerveKinematics, getYaw(), getModulePositions());
    }

    public void drive(Translation2d translation, double rotation, boolean fieldRelative, boolean isOpenLoop) {
        SwerveModuleState[] swerveModuleStates =
            Constants.SwerveConst.swerveKinematics.toSwerveModuleStates(
        ...
        SwerveDriveKinematics.desaturateWheelSpeeds(swerveModuleStates, Constants.SwerveConst.maxSpeed);
    ...
    public Rotation2d getYaw() {
        return ((Constants.SwerveConst.invertGyro) ? Rotation2d.fromDegrees(360 - gyro.getYaw()) : Rotation2d.fromDegrees(gyro.getYaw()));
    }
