...
public class ShootingSubsystem extends SuperSystem {
  ...
  public ShootingSubsystem() {
    ...
    masterShooterMotor = new SuperTalonFX(Constants.MASTER_SHOOTER_MOTOR_ID, Constants.CanBus.RIO, 40, false, false, NeutralMode.Coast, shooterGains, TalonFXControlMode.Velocity, 0, 0,0); 
    slaveShooterMotor = new SuperTalonFX(masterShooterMotor, Constants.SLAVE_SHOOTER_MOTOR_ID, Constants.CanBus.RIO, 40, false);
