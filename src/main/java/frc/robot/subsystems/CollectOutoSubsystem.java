...
public class CollectOutoSubsystem extends SuperSystem {
  ...
  /**
   * @param collectOutoSubsystem
   * 
   */
  public CollectOutoSubsystem(CollectOutoSubsystem collectOutoSubsystem) {
    super("CollectOutoSubsystem");
