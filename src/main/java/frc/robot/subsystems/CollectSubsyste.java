...
public class CollectSubsyste extends SuperSystem {
  ...
  public CollectSubsyste() {
    ...
    leaderCollectMotor = new SuperTalonSRX(Constants.LEADER_COLLECT_MOTOR, 0, false, false, 0, 0, 0, collectGains, null);
    collectMotor = new SuperTalonSRX(leaderCollectMotor, Constants.COLLECT_MOTOR, 0, true);
