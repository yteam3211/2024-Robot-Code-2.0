...
public class AutoKickerCommand extends Command {
  ...
  @Override
  public void execute() {
    System.out.println("velocity: " + ((Constants.SHOOTING_SPEAKER_VELCITY - 4000) < shootingSubsystem.getVelocity()));
    if((Constants.SHOOTING_SPEAKER_VELCITY - 4000) < shootingSubsystem.getVelocity()){
