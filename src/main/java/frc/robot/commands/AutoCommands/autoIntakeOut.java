...
public class autoIntakeOut extends SequentialCommandGroup {
  /** Creates a new IntakeAndTransferCommand. */
  public autoIntakeOut(IntakeSubsystem intakeSubsystem, TransferSubsystem transferSubsystem,ShootingSubsystem shootingSubsystem,KickerSubsystem kickerSubsystem,PitchingSubsystem pitchingSubsystem,double intakeVelocity, double tranforOutput ) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
      addCommands(
        new ParallelCommandGroup(
          new IntakeBackwordsCommand(intakeSubsystem, 6000).onlyIf(() -> KickerSubsystem.isNoteIn()),
