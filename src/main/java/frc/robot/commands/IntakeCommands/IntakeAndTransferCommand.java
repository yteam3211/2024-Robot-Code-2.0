...
public class IntakeAndTransferCommand extends ParallelCommandGroup {
  ...
  public IntakeAndTransferCommand(IntakeSubsystem intakeSubsystem, TransferSubsystem transferSubsystem,ShootingSubsystem shootingSubsystem) {
    ...
    addCommands(
      ...
      new KickerCommand(shootingSubsystem, 0.5)
    );
  }
}
