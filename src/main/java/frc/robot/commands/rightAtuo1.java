...
import frc.robot.autos.rightToRampa;
...
public class rightAtuo1 extends SequentialCommandGroup {
  /** Creates a new atuo1. */
  ...
  public rightAtuo1(Swerve s_Swerve2,
  ...
  GripperSubsystem gripperSubsystem
    ...
    rightToRampa.getAutoCommand(s_Swerve));
  }
}