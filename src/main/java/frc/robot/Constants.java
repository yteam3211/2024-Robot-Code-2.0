...
public final class Constants {
    ...
    // shooting constants
    public static final double SHOOTING_ANGLE_TRESHOLD = 1; 
    public static final double SHOOTING_VELOCITY_TRESHOLD = 700;  
    public static final double SHOOTING_SPEAKER_VELCITY = 16500; 
    public static final double SHOOTING_AMP_OUTPUT = 0.4; 
        public static final double KICKER_OUTPUT = 0.8; 
    
    
    // pitching constants
    public static final double PITCHING_ENCODER_OFFSET = Units.rotationsToDegrees(-0.016113); //in degrees
    ...
    public static final double MIN_PITCHING_ANGLE = -45;  
    ...
    // elevator constnats
    public static final double ELEAVATOR_TRESHOLD = 5; 
    ...
    public static final double ELEVATOR_ENCODER_TICKS_PER_MILLIMETER = 203732 / 562; // x (raw encoder units) / y (Millimeters)
    ...
    public static final double CLIMB_ELEVATOR_HIGHT = 580;
    public static final double HOOK_OPEN_POSITION = -1700;
    public static final double HOOK_LOCK_POSITION = -300;


    // swerve constants
    public static final double TURN_SWERVE_TRESHOLD = 2;
    ...
    // intake constants
    public static final double INTAKE_OPEN_POSITION = 30; // in rotations 
    public static final double INTAKE_WHEELS_OUTPUT = 0; 
    public static final double INTAKE_WHEELS_VELOCITY = -6000; 

    // alliance constants
    public static final Pose2d BLUE_SPEAKER_POS = new Pose2d(new Translation2d(0, 5.55), new Rotation2d());
    public static final Pose2d RED_SPEAKER_POS = new Pose2d(new Translation2d(0, 2.66), new Rotation2d());
    ...
    public static final int KICKER_MICROSWITCH_ID = 4;

    
    public static final int TRANSFER_MOTOR_ID = 26;
    ...
    public static final class SwerveConstant {
        ...
        public static final class Mod0 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(Units.rotationsToDegrees(0.170166)); 
        ...
        public static final class Mod1 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(Units.rotationsToDegrees(0.936523));
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod2 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(Units.rotationsToDegrees(0.273926));
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod3 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(Units.rotationsToDegrees(0.245605));
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
    }
