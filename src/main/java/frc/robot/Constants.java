...
public final class Constants {
    ...
    // pitching constants
    public static final double PITCHING_ENCODER_OFFSET = Units.rotationsToDegrees(0.014160); //in degrees
    ...
    // intake constants
    public static final double INTAKE_OPEN_POSITION = 35; // in rotations 
    ...
    public static final class SwerveConstant {
        ...
        public static final class Mod0 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(Units.rotationsToDegrees(0.668701)); 
        ...
        public static final class Mod1 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(Units.rotationsToDegrees(0.443848));
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod2 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(Units.rotationsToDegrees(0.790283));
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
